...
def run_alphabet_exercise():
    ...
    while True:
        ...
        user_input = input("Enter the letter after it (or type 'exit' to stop): ")
        ...
        if user_input.upper() == f"{after_letter}":
            print("Correct!")
        else:
            print(f"Incorrect! The correct answer was {after_letter}.")
