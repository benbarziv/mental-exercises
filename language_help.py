...
def run_alphabet_exercise():
    ...
    while True:
        ...
        user_input = input("Enter the letters before and after it (or type 'exit' to stop): ")
        ...
        if user_input.upper() == f"{before_letter}{after_letter}":
            print("Correct!")
        else:
            print(f"Incorrect! The correct answer was {before_letter}{after_letter}.")
